...
var ADDRESS_ERR_LOOKUP = {
  SERVER: 'There appears to be a problem with the server. Please try again, and if the problem persists, email us at info@apartmentsmart.com with the subject Contact Congress.',
